...
public class WarmUpNames {
	public static void main(String[] args) {
		...
		// print male names in single line separated by coma
		...
		// print all names that are up to 4 characters in
		// upper case in same line
		...
		String str1 = "first word";//str2
		String str2 = "second word";//str1
