...
public class Split {
	...
	public static void main(String[] args) {
		...
		String[] diceArray2 = diceResult.split("of");// or(" of ") space will disappear
		System.out.println(diceArray2[0].trim());//index 0
		System.out.println(diceArray2[1].trim());//index 1
